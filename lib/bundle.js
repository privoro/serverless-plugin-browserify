...
module.exports = {
  bundle(functionName) {
    ...
    let runtime = functionObject.runtime || this.serverless.service.provider.runtime || '';
    if (runtime.indexOf('nodejs') === -1) {
      this.serverless.cli.log(`runtime is not node js on ${functionName} or the provider in serverless.yml, Skipping Browserify...`);
      return;
    }
