...
module.exports = {
  ...
  getFunctionConfig(functionName) {
    ...
    let runtime = functionBrowserifyConfig.runtime || this.serverless.service.provider.runtime || '';

    if (runtime.indexOf('nodejs') === -1) {
      throw new this.serverless.classes.Error('runtime is not node js on this function or the provider in serverless.yml', 'skip');
    }
